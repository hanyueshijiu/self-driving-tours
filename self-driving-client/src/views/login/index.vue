<template>
  <div class="container">
    ...
    <div class="header">
      ...
      <div class="iconBox" @click="goHome"><HomeFilled />首页</div>
    </div>
    <div class="box">
      <div class="image"></div>
      <!--  -->
...
.container {
  ...
  .box {
    ...
    .image {
      width: 25em;
      height: 30rem;
      background-image: url(https://tse2-mm.cn.bing.net/th/id/OIP-C.YKacydMFQxadXqu2xdXTmgHaLJ?rs=1&pid=ImgDetMain);
